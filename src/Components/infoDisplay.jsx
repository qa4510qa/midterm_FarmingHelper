...
class InfoDisplay extends React.Component {
  render() {
    ...
    return (
      <div>
				<div style={{paddingBottom:"10px",border:"2px gray solid"}}>
					...
					<div style={{border:"2px gray solid"}}>
						...
						<div style={{borderBottom:"2px gray solid",padding:"5px"}}>
							<div style={{margin:"5px"}}>
								<button style={{flex:3,display:"flex",flexDirection:"row",border:"1px black solid",borderRadius:"5px"}} onClick={()=>{switchScreen("Info")}}>
								...
								<div style={{flex:7,display:"flex",flexDirection:"row",paddingLeft:"5px"}}>
									<p style={{textAlign:"left",fontSize:"20px",margin:"5px",marginTop:"10px",color:"black"}}>一、主要功能：</p>
						...
						<div style={{borderBottom:"2px gray solid",padding:"5px"}}>
							<div style={{margin:"5px"}}>
								<button style={{flex:3,display:"flex",flexDirection:"row",border:"1px black solid",borderRadius:"5px"}} onClick={()=>{switchScreen("Main")}}>
							...
							<div style={{paddingLeft:"5px"}}>
								<div>
									<p style={{textAlign:"left",fontSize:"20px",margin:"10px",marginTop:"10px",color:"black"}}>二、輸入資料：</p>
									<div style={{display:"flex",flex:1,flexDirection:"row",marginBottom:"10px"}}>
										<div style={{flex:6}}>
											<div >
										...
										<div style={{flex:4,textAlign:"right"}}>
											<img style={{width:"350px",height:"400px"}} src={'Public/img/MainDisplayFinal.jpeg'} />
										</div>
									</div>
								</div>
							</div>
							<div style={{paddingLeft:"5px"}}>
								<div>
									<p style={{textAlign:"left",fontSize:"20px",margin:"20px",color:"black"}}>三、試算結果：</p>
									<div style={{display:"flex",flex:1,flexDirection:"row",marginBottom:"10px"}}>
										<div style={{flex:6}}>
											<div >
										...
										<div style={{flex:4,textAlign:"right"}}>
											<img style={{width:"350px",height:"400px"}} src={'Public/img/OptAnsDisplayFinal.jpeg'} />
										</div>
									</div>
								</div>
							</div>
						...
						<div style={{borderBottom:"2px gray solid",padding:"5px"}}>
							<div style={{margin:5,flexDirection:"row"}}>
								<button style={{flex:3,display:"flex",flexDirection:"row",border:"1px black solid",borderRadius:"5px"}} onClick={()=>{switchScreen("FutureClimate")}}>
								...
								<div style={{flex:7,display:"flex",flexDirection:"row",paddingLeft:5}}>
									<p style={{textAlign:"left",fontSize:20,margin:5,marginTop:10,color:"black"}}>一、主要功能：</p>
									<p className={"InfoDisplayContent"}>
										呈現未來季長期預測之氣候資料。
									</p>
								</div>
							...
							<div style={{paddingLeft:"5px"}}>
								...
								<div>
									<p style={{textAlign:"left",fontSize:"20px",margin:"10px",color:"black"}}>二、說明：</p>
									<div >
						...
						<div style={{paddingLeft:"5px"}}>
							<div style={{margin:"5px",flexDirection:"row"}}>
								<button style={{flex:3,display:"flex",flexDirection:"row",border:"1px black solid",borderRadius:"5px"}} onClick={()=>{switchScreen("CropData")}}>
							...
							<div>
								<div>
									<p style={{textAlign:"left",fontSize:"20px",margin:"15px",color:"black"}}>二、說明：</p>
